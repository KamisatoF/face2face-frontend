...
import RelatorioLocacao from './pages/RelatorioLocacao';
    ...
    <AuthProvider>
      <BrowserRouter>
        <Routes>
          ...
          <Route exact path="/relatoriolocacao" element={<PrivateRoute navigateTo="/login"><RelatorioLocacao /></PrivateRoute>} />
